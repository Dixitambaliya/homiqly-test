...
const DashboardLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/vendors', name: 'Vendors', icon: <FiUserCheck className="w-5 h-5" /> },
    { path: '/users', name: 'Users', icon: <FiUsers className="w-5 h-5" /> },
    { path: '/services', name: 'Services', icon: <FiShoppingBag className="w-5 h-5" /> },
    ...
    { path: '/contractors', name: 'Contractors', icon: <FiTool className="w-5 h-5" /> },
    { path: '/employees', name: 'Employees', icon: <FiUserPlus className="w-5 h-5" /> },
    ...
    { path: '/notifications', name: 'Notifications', icon: <FiBell className="w-5 h-5" /> },
  ];

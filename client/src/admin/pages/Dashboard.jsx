...
import { FiUsers, FiUserCheck, FiCalendarCheck, FiDollarSign } from 'react-icons/fi';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-2xl font-semibold">₹{stats.total_revenue || 0}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link to="/admin/bookings" className="text-sm text-primary-light hover:text-primary-dark font-medium">
            View All Bookings
          </Link>
        </div>

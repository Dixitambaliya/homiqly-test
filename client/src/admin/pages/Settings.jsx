      ...
      <Card title="Account Information">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-gray-900">{currentUser?.email || 'admin@example.com'}</p>
          </div>
          <div>
            <h4 className="text-sm font-medium text-gray-500 mb-1">Role</h4>
            <p className="text-gray-900 capitalize">{currentUser?.role || 'admin'}</p>
          </div>
          <div>
            <h4 className="text-sm font-medium text-gray-500 mb-1">Last Login</h4>
            <p className="text-gray-900">Today at {new Date().toLocaleTimeString()}</p>
          </div>
        </div>
      </Card>
    </div>

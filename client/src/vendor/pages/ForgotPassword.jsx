...
const ForgotPassword = () => {
  ...
  const { requestPasswordReset, verifyResetCode, resetPassword } = useVendorAuth();
      ...
      {step === 1 && (
        <div>
          ...
          <div className="mt-6 text-center">
            <Link to="/vendor/login" className="text-sm font-medium text-primary-light hover:text-primary-dark">
              Back to Login
            </Link>
          </div>
        </div>

...
const registerAdmin = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const insertResult = await db.query(adminAuthQueries.adminInsert, [email, name, hashedPassword])

        res.status(200).json({ message: "Admin created", admin_id: insertResult.insertId, name });
    ...
    try {
        ...
        const responsePayload = {
            user: {
                ...
                photoURL: "https://api-dev-minimal-v630.pages.dev/assets/images/avatar/avatar-25.webp", // optional static image
                ...
                about: admin.about || "Praesent turpis. Phasellus viverra nulla ut metus varius laoreet.",
                role: "admin",
                isPublic: true,
                email: admin.email,
...
const resetPassword = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await db.query(adminAuthQueries.resetAdminPassword, [hashedPassword, email]);
...
const changeAdminPassword = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await db.query(adminAuthQueries.resetAdminPassword, [hashedNewPassword, email]);

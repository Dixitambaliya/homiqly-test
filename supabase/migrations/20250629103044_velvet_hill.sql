-- Homiqly Database Fake Data (Corrected for Existing Data)
...
DELETE FROM service_booking_sub_packages;
DELETE FROM service_booking_packages;
DELETE FROM service_booking_types;
DELETE FROM service_preferences;
DELETE FROM service_booking;
DELETE FROM cart_package_items;
DELETE FROM cart_preferences;
DELETE FROM cart_packages;
DELETE FROM service_cart;
DELETE FROM booking_preferences;
DELETE FROM package_items;
DELETE FROM packages;
DELETE FROM service_type;
DELETE FROM individual_services;
DELETE FROM company_services;
DELETE FROM individual_service_categories;
DELETE FROM company_service_categories;
DELETE FROM individual_details;
DELETE FROM company_details;
DELETE FROM vendors;
DELETE FROM inventory_movements;
DELETE FROM inventory;
DELETE FROM vendor_supply_kits;
DELETE FROM supply_kit_items;
DELETE FROM supply_kits;
DELETE FROM contractor_bookings;
...
DELETE FROM contractor_payouts;
...
-- Only clear admin if it exists and is not the default
DELETE FROM admin WHERE email != 'admin@homiqly.com';

SET FOREIGN_KEY_CHECKS = 1;

-- Insert Admin Users (only if they don't exist)
INSERT IGNORE INTO admin (email, name, password, role) VALUES
...
(1, 'Lipstick Collection', 'Assorted lipstick colors', 10, 80.00, CONCAT('HMQ1004_', UNIX_TIMESTAMP())),
...
(2, 'Drain Snake', 'Flexible drain cleaning tool', 1, 800.00, CONCAT('HMQ2004_', UNIX_TIMESTAMP())),

-- Cleaning Supplies Kit
(3, 'All-Purpose Cleaner', 'Multi-surface cleaning solution', 5, 120.00, CONCAT('HMQ3001_', UNIX_TIMESTAMP())),
(3, 'Microfiber Cloths', 'Professional cleaning cloths', 20, 25.00, CONCAT('HMQ3002_', UNIX_TIMESTAMP())),
(3, 'Vacuum Bags', 'Universal vacuum cleaner bags', 10, 30.00, CONCAT('HMQ3003_', UNIX_TIMESTAMP())),
(3, 'Disinfectant Spray', 'Hospital-grade disinfectant', 3, 200.00, CONCAT('HMQ3004_', UNIX_TIMESTAMP()));
